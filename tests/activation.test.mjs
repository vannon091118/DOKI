...
test("Etappe 1: ensemble in prompt carries all ACTIVE characters and relationships from etats", async () => {
  ...
  assert.equal(Object.keys(ensembleStripe.characters).length, 3);

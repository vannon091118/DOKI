...
export const ACTIVE_NARRATOR_NAMES = Object.freeze(['Buffy', 'Squizzle', 'Null']);
...
// 'Thinker'/'Buffy' als Strings in ensemble-state.mjs, runtime.mjs und
...
export const ROLE_MAP = Object.freeze({
  ...
  attack: 'Buffy',        // evil/evil-twin-Stimme (unverändert)
